...
<body>
    <form id="form2" runat="server">
        ...
        <br />
                                        <br />
                                        <asp:LinkButton ID="LinkButton2" runat="server" OnClick="LinkButton2_Click">编辑路线</asp:LinkButton>
                                        <br />
                                        <br />
                                        <asp:LinkButton ID="LinkButton3" runat="server" OnClick="LinkButton3_Click">编辑景点</asp:LinkButton>
                                        <br />
                                        <br />
                                         <asp:LinkButton ID="LinkButton9" runat="server" OnClick="LinkButton9_Click">查看订单</asp:LinkButton>
                                        <br />
                                        <br />
