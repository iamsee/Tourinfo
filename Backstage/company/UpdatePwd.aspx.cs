...
public partial class Customer1_UpdatePwd : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        TextUserMail.Text = Session["CompMail"].ToString();
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        //update TB_Customer set CustPwd ='123' where CustPwd = '2' and CompMail ='2';

        sqlString = "update TB_Company set CompPwd ='" + userNewpwd + "' where CompPwd = '" + userOldpwd + "' and CompMail ='" + Session["CompMail"].ToString() + "'";
