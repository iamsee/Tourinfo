<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CompInfo.aspx.cs" Inherits="Backstage_admin_CompInfo" %>
                  ...
                  <td align="center"><font color="#FF3300"><b><br>
                   公司信息
                     ...
                     <form id="form1" runat="server">
                         ...
                         <asp:GridView ID="GV_showCompInfo" runat="server" AutoGenerateColumns="False" AllowPaging="true" PageSize="10" OnPageIndexChanging="GV_showCompInfo_PageIndexChanging" style="margin-bottom: 0px" OnRowCancelingEdit="GV_showCompInfo_RowCancelingEdit" OnRowEditing="GV_showCompInfo_RowEditing" OnRowUpdating="GV_showCompInfo_RowUpdating" OnRowDeleting="GV_showCompInfo_RowDeleting" >
                             <Columns>
