                          ...
                          <center>
                              ...
                              <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand">
                                  <Columns>
                                      ...
                                      <asp:ButtonField ButtonType="Button" HeaderText="取消订单" CommandName="COrder" Text="取消" />
                                      <asp:ButtonField ButtonType="Button" HeaderText="支付订单" Text="支付" CommandName="GoOrder" />
                                  </Columns>
                              </asp:GridView>
