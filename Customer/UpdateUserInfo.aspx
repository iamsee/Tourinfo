<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdateUserInfo.aspx.cs" Inherits="Customer1_UpdateUserInfo" %>
                        ...
                        <table width="80%" border="0" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC" align="center">
                          ...
                          <tr bgcolor="#FFFFFF">
                            ...
                            <td width=70% class=pad>
                                ...
                                <asp:TextBox ID="TextMail" runat="server" Enabled="False"></asp:TextBox><font color="red">*</font>
                            </td>
                          </tr>
                          <tr bgcolor="#FFFFFF">
                            <td width=30% align=right class="style1"> 密　　码：</td>
                            <td class=style1>
                            <asp:TextBox ID="TextPwd" runat="server"></asp:TextBox><font color="red">*</font>
                          ...
                          <tr bgcolor="#FFFFFF">
                            ...
                            <td class=pad><asp:TextBox ID="TextRealName" runat="server"></asp:TextBox><font color="red">*</font></td>
                          </tr>
                          <tr bgcolor="#FFFFFF">
