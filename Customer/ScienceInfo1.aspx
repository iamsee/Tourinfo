<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ScienceInfo1.aspx.cs" Inherits="Customer1_About" %>
                        ...
                        <TABLE cellSpacing=0 cellPadding=0 width=770 border=0>
                          ...
                          <center>
                              <br />
                                    ...
                                    <asp:Label ID="Label1" runat="server" Text="按景点名"></asp:Label>
                                    <asp:TextBox ID="TextScenicName" runat="server" Width="94px"></asp:TextBox>
