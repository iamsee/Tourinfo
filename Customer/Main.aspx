                            ...
                            <tr>
                                <td valign="top" class="style1">
                                    ...
                                    <center>
                                        ...
                                        <br />
                                        <br />
                                        <asp:LinkButton ID="LinkButton7" runat="server" OnClick="LinkButton6_Click">修改个人信息</asp:LinkButton>
                                        <br />
                                        <br />
                                        <asp:LinkButton ID="LinkButton6" runat="server" OnClick="LinkButton7_Click">查看个人信息</asp:LinkButton>
                                        <br />
                                        <br />
                                        <asp:LinkButton ID="LinkButton8" runat="server" onclick="LinkButton8_Click">查看订单信息</asp:LinkButton>
                                        <br />
                                        <br />
                                        <asp:LinkButton ID="LinkButton3" runat="server" onclick="LinkButton3_Click">查看景点信息</asp:LinkButton>
                                        <br /> 
                                        <br />
                                        <asp:LinkButton ID="LinkButton2" runat="server" OnClick="LinkButton2_Click">查看路线</asp:LinkButton>
                                        <br />
                                        <br />
                                        <br />
                                        <br />
                                    ...
                                    <table>
                                        <tr>
                                            <td width="180" height="136">
                                                <div align="center"><a href="SciencePictureInfo1.aspx" title="">
                                                    <img src="img/1.jpg" width="160" height="120" border="0"></a></div>
                                            </td>

                                            <td width="181">
                                                <div align="center"><a href="SciencePictureInfo2.aspx" title="">
                                                    <img src="img/2.jpg" width="160" height="120" border="0"></a></div>
                                            </td>

                                            <td width="178">
                                                <div align="center"><a href="SciencePictureInfo3.aspx" title="">
                                                    <img src="img/3.jpg" width="160" height="120" border="0"></a></div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td width="180" height="136">
                                                <div align="center"><a href="SciencePictureInfo4.aspx" title="">
                                                    <img src="img/4.jpg" width="160" height="120" border="0"></a></div>
                                            </td>

                                            <td width="181">
                                                <div align="center"><a href="SciencePictureInfo5.aspx" title="">
                                                    <img src="img/5.jpg" width="160" height="120" border="0"></a></div>
                                            </td>

                                            <td width="178">
                                                <div align="center"><a href="SciencePictureInfo6.aspx" title="">
                                                    <img src="img/6.jpg" width="160" height="120" border="0"></a></div>
                                            </td>
                                        </tr>
