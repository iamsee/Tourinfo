...
public partial class Customer1_About : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string sql1 = "select pathname 线路名,CompName 公司名称,pathprice 价格,totalpeople 最大人数,finalpeople 已报人数,PathState 线路状态";
        string sql2 = ",PathStay 住宿信息,PathFood 餐饮信息,Pathtraffice  交通信息,PathGuide 导游信息  from TB_Path,TB_Company ";
        string sql3 = " where TB_Company.CompID = TB_Path.CompID   and pathname = '" + TextPathName.Text.Trim() + "' order by pathprice asc;";
        string sql = sql1 + sql2 + sql3;
        ds = db.GetDataSet(sql);
